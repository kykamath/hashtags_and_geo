...
#        print i, datetime.fromtimestamp(tu), len(timeUnitsToDataMap[tu]['oc']), len(filter(lambda l: l[1] in LOCATIONS_LIST,timeUnitsToDataMap[tu]['oc']))
...
if __name__ == '__main__':
    ...
    predictionModels = [PredictionModels.greedy]
