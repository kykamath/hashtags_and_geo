...
#        noOfHashtagsList=map(lambda i: i*5, range(1,21))
        ...
        for i in range(2,7):
#        for i in [2]:
            conf = dict(historyTimeInterval = timedelta(seconds=8*TIME_UNIT_IN_SECONDS), predictionTimeInterval = timedelta(seconds=i*TIME_UNIT_IN_SECONDS), noOfHashtagsList=noOfHashtagsList)
