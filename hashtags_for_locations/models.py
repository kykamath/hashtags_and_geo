...
#            for model_id in metric_values_for_model:
    ...
    def generateDataForVaryingNumberOfHastags():
        ...
        conf = dict(historyTimeInterval = timedelta(seconds=2*TIME_UNIT_IN_SECONDS), predictionTimeInterval = timedelta(seconds=6*TIME_UNIT_IN_SECONDS), noOfHashtagsList=noOfHashtagsList)
