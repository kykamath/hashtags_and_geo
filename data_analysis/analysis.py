...
from settings import hdfs_input_folder, \
    ...
    f_tuo_iid_and_tuo_is_peak_and_cumulative_percentage_of_occurrences
...
#    output_file = f_tuo_rank_and_average_percentage_of_occurrences%(input_files_start_time.strftime('%Y-%m-%d'), input_files_end_time.strftime('%Y-%m-%d'), min_hashtag_occurrences)
    output_file = f_tuo_iid_and_tuo_is_peak_and_cumulative_percentage_of_occurrences%(input_files_start_time.strftime('%Y-%m-%d'), input_files_end_time.strftime('%Y-%m-%d'), min_hashtag_occurrences)
